...
try {
  ...
  console.log('✅ Lisha (iPad A) 成功以【海盗 Pirate】身份登船进入 CORAL');
  ...
  console.log('✅ Quentin (iPad B) 成功以【潜水员 Diver】身份登船进入 CORAL');
  ...
  const diverToken = await pageB.evaluate(() => localStorage.getItem('coral-token:CORAL:diver'));
  ...
  await pageTeacher.fill('#room', 'CORAL');
